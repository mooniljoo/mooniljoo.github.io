...
function Header(_ref) {
  ...
  return __jsx("header", {
    ...
    return __jsx("li", {
      ...
      title: e.title,
      className: "jsx-4080026448" + " " + "\"menu__link\" ".concat(pathname == "/" + e.title, "\n                      "),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 44,
